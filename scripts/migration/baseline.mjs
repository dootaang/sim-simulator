...
const commands = [['platform-check','pnpm',['check'],root]];
const results = {};
...
const files = ['schema/yongsa-inn.v0.json','schema/generic-combat.v0.json','packages/modules/test/inn.test.ts','packages/modules/test/combat.test.ts','examples/alternate-hunters-v2/project.json'];
