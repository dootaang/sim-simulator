...
export interface RuntimeClientWarning{code:'runtime_timeout'|'runtime_disposed'|'runtime_stale_response'|'runtime_worker_error'|'runtime_budget_rejected'|'runtime_soft_timeout';requestId:string;message:string}
